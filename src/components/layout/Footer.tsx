...
export function Footer({ onNavigateToAllies }: FooterProps) {
  return (
    <motion.footer 
      ...
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-6 md:flex-row md:items-center md:justify-between border-x border-violet-500/20 px-6 sm:px-8 lg:px-12 py-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <button
            ...
            className="px-6 py-3 rounded-full bg-gradient-to-r from-indigo-500 via-violet-500 to-cyan-500 text-xs font-semibold tracking-[0.3em] uppercase hover:shadow-md hover:shadow-violet-500/30 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-50"
          >
            Work With Shaivra
          </button>
